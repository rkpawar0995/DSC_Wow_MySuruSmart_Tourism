    ...
    public void onBindViewHolder(@NonNull final FoodViewHolder foodViewHolder, int i) {
        ...
        foodViewHolder.mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("name",myFoodList.get(foodViewHolder.getAdapterPosition()).getName());
                intent.putExtra("dec",myFoodList.get(foodViewHolder.getAdapterPosition()).getDec());
